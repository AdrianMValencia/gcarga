<aside class="main-sidebar sidebar-light-primary elevation-4">
    <a href="start" class="brand-link">
        <img src="public/img/template/icono-negro.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">GCarga</span>
    </a>
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="" class="img-circle elevation-2" alt="">
                <img src="public/img/users/default/adm.png" class="img-circle elevation-2" alt="">
            </div>
            <div class="info">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="customs-broker" class="nav-link">
                                        <i class="nav-icon fas fa-globe"></i>
                                        <p>Agente de Aduana</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="bulking-agent" class="nav-link">
                                        <i class="nav-icon fas fa-truck-loading"></i>
                                        <p>Agente de Carga</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="foreign-agent" class="nav-link">
                                        <i class="nav-icon fas fa-handshake"></i>
                                        <p>Agente Exterior / Coloaded</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="shipping-agent" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="container-type" class="nav-link">
